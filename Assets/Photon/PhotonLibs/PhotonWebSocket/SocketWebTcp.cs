...
namespace ExitGames.Client.Photon
{
    ...
    public class SocketWebTcp : IPhotonSocket, IDisposable
    {
        ...
        public SocketWebTcp(PeerBase npeer) : base(npeer)
        {
            ...
            {
                this.Listener.DebugReturn(DebugLevel.INFO, "SocketWebTcp() "+ WebSocketPhoton.Implementation+". Server: " + this.ServerAddress + (String.IsNullOrEmpty(this.ProxyServerAddress) ? "" : ", Proxy: " + this.ProxyServerAddress));
            }
        ...
        public override bool Connect()
        {
            ...
            try
            {
                this.sock = new WebSocketPhoton(new Uri(this.ConnectAddress), proxyServerAddress, this.OpenCallback, this.ReceiveCallback, this.ErrorCallback, this.CloseCallback, this.SerializationProtocol);
