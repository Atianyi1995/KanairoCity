...
namespace ExitGames.Client.Photon
{
    ...
    public partial class WebSocketPhoton
    {
        ...
        public WebSocketPhoton(Uri url, string proxyAddress, Action openCallback, Action<byte[], int>  recvCallback, Action<int, string> errorCallback, Action<int, string> closeCallback, string protocols = null)
        {
            this.Url = url;
    ...
    public partial class WebSocketPhoton
    {
        ...
        static Dictionary<int, WebSocketPhoton> instances = new Dictionary<int, WebSocketPhoton>();
